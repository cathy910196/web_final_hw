...
<body background="image/bk03.gif">
<?php
session_start();
...
function initMap() {
  ...
  var map = new google.maps.Map(document.getElementById('map'), {
    center: {lat: 25.065624, lng: 121.521722},
    zoom: 17
  });
	//var taipeiStation = new google.maps.LatLng(25.065624, 121.521722);
   var marker = new google.maps.Marker({
	
    position: {lat: 25.065624, lng: 121.522722},
   //position:  (25.065624,121.521722),
    map: map,
    title: 'Hello World!'
  });
////////這裡是轉地址專用地////////////////
...
geocoder.geocode({ address: '台北市中山區雙城街19巷5號' },
